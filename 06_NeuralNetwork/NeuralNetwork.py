...
class NeuralNetwork:
    def __init__(self, layers, activation = 'tanh'):
        '''
        :param layers: A list containing the number of units in each layer. Should be at least 2 values
    ...
    def fit(self, X, y, learning_rate = 0.2, epochs = 10000):
        ...
        for k in range(epochs):
            ...
            for l in range(len(a) - 2, 0, -1): # we need to begin at the second last layer
                # compute the updated error for each node
